        ...
        <div class="col-md-2">
            <nav class="nav flex-column bg-info">
              <center>
                  ...
                  <a class="nav-link text-white" href="{{route ('cards')}}">Cards</a>
                  <a class="nav-link text-white" href="{{route('carousel.index')}}">Slides</a>
                  <a class="nav-link text-white" href="{{route('contato.index')}}">Depoimentos</a>
                  <a class="nav-link text-white" href="{{route('textos.index')}}">Textos</a>
